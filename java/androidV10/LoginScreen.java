...
public class LoginScreen {
	...
	By PhoneNumber = By.id("tech.gplanet.shopx:id/cl_phone_number");
	By PhoneNumberField = By.id("tech.gplanet.shopx:id/et_phone_field");
	...
	public void Login() {
		...
		driver.findElement(PhoneNumberField).sendKeys("01061334326");
